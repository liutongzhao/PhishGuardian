...
使用方法：
    from qq_email_simple import get_new_emails
...
def get_new_emails(email_addr, password, last_uid):
    ...
    参数:
        email_addr (str): QQ邮箱地址
        password (str): QQ邮箱授权码
...
def main():
    ...
    """
    # 测试配置（请修改为实际的邮箱信息）
    email_addr = '1917225343@qq.com'
    password = 'pqkazehhhteceaei'
    last_uid = 1111  # 从UID 1开始获取所有邮件（用于测试）
